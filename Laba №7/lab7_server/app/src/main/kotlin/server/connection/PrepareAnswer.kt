...
fun ping(clientAddress: InetSocketAddress, serverSocket: DatagramSocket) : MutableMap<String, Any?>{
...
fun execCommand(clientAddress: InetSocketAddress, serverSocket: DatagramSocket, message: Map<String, Any?>, connection: Connection): MutableMap<String, Any?>{
    val map = mutableMapOf<String, Any?>()
    try {
...
fun clientLogin(clientAddress: InetSocketAddress, serverSocket: DatagramSocket, message: Map<String, Any?>, connection: Connection): MutableMap<String, Any?>{
...
fun clientRegister(clientAddress: InetSocketAddress, serverSocket: DatagramSocket, message: Map<String, Any?>, connection: Connection): MutableMap<String, Any?>{
    val login = message["login"].toString()
    val password = message["password"].toString()
    val map = mutableMapOf<String, Any?>()
    val statement = connection.prepareStatement("SELECT * FROM users WHERE login = ?")
